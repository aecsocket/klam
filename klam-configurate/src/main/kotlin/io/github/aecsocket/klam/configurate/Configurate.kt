...
internal fun ConfigurationNode.force(type: Type) =
    get(type) ?: throw SerializationException(this, type, "A value is required for this field")

internal fun <V : Any> ConfigurationNode.force(type: KClass<V>) =
    get(type.java)
        ?: throw SerializationException(this, type.java, "A value is required for this field")

internal fun <V : Any> ConfigurationNode.force(type: TypeToken<V>) =
...
internal inline fun <reified T> TypeSerializerCollection.Builder.registerExact(
